...
const EVENT_CATEGORIES = {
  ...
  regulatory: { label: "Regulatory", color: T.red, bg: T.redLight, icon: "⚖️" },
  rate_change: { label: "Rate Change", color: T.orange, bg: T.orangeLight, icon: "📉" },
...
const fundEvents = [
  {
    ...
    clientsImpacted: [
      { id: 3, name: "Priya Sharma", accounts: ["Non-Reg"], funds: ["RBF617", "RBF275"], estTax: 4200, action: "Review asset location" },
      { id: 7, name: "Linda Martinez", accounts: ["Non-Reg"], funds: ["RBF275"], estTax: 1800, action: "Consider tax-loss harvesting" },
      { id: 10, name: "James O'Brien", accounts: ["Non-Reg"], funds: ["RBF266"], estTax: 950, action: "Discuss TFSA contribution room" },
      { id: 11, name: "Catherine Tremblay", accounts: ["Non-Reg"], funds: ["RBF266"], estTax: 3600, action: "DS referral — complex tax situation" },
      { id: 13, name: "Rachel Nguyen", accounts: ["Non-Reg"], funds: ["RBF290"], estTax: 420, action: "Low impact — monitor only" },
    ],
  },
  {
    id: "fe2",
    ...
    clientsImpacted: [
      { id: 1, name: "Margaret Chen", accounts: ["RRSP"], funds: ["RBF571"], estTax: null, action: "Share good news — fee reduction" },
      { id: 2, name: "David Thompson", accounts: ["RRSP", "TFSA"], funds: ["RBF572", "RBF573"], estTax: null, action: "Great retention conversation" },
      { id: 4, name: "Jean-Pierre Dubois", accounts: ["TFSA"], funds: ["RBF572"], estTax: null, action: "Share fee reduction — build trust" },
      { id: 6, name: "Michael Okafor", accounts: ["FHSA"], funds: ["RBF572"], estTax: null, action: "Positive touchpoint" },
      { id: 9, name: "Fatima Al-Hassan", accounts: ["RRSP"], funds: ["RBF572"], estTax: null, action: "Use as re-engagement opportunity" },
      { id: 12, name: "Ahmed Patel", accounts: ["TFSA"], funds: ["RBF572"], estTax: null, action: "Build relationship — proactive update" },
      { id: 14, name: "Brian Fowler", accounts: ["RRSP"], funds: ["RBF572"], estTax: null, action: "Anchor with fee competitiveness" },
      { id: 15, name: "Amira Hassan", accounts: ["FHSA"], funds: ["RBF572"], estTax: null, action: "Positive early touchpoint" },
    ],
  },
  {
    id: "fe3",
    ...
    clientsImpacted: [
      { id: 5, name: "Sandra Williams", accounts: ["RRIF"], funds: ["RBF140"], estTax: null, action: "Coordinate with RRIF minimum withdrawal" },
      { id: 8, name: "Robert Kim", accounts: ["RRSP"], funds: ["RBF220"], estTax: null, action: "No action — tax sheltered" },
      { id: 1, name: "Margaret Chen", accounts: ["RRSP"], funds: ["RBF140"], estTax: null, action: "No action — tax sheltered" },
      { id: 10, name: "James O'Brien", accounts: ["RRSP"], funds: ["RBF140"], estTax: null, action: "No action — tax sheltered" },
    ],
  },
  {
    id: "fe4",
    title: "FHSA Annual Contribution Limit Increase",
    category: "regulatory",
    date: "2026-01-01",
    summary: "2026 FHSA contribution room now available ($8,000/year, $40,000 lifetime). Opportunity to re-engage younger clients and prospects who haven't maxed contributions. Unused room carries forward.",
    resources: [
      { title: "CRA FHSA Rules — 2026 Update", url: "https://www.canada.ca/en/revenue-agency/services/tax/individuals/topics/fhsa.html" },
      { title: "FHSA Client Conversation Guide", url: "https://advisor.rbcgam.com/resources/fhsa-guide" },
      { title: "FHSA vs RRSP — Comparison Tool", url: "https://advisor.rbcgam.com/tools/fhsa-rrsp-compare" },
    ],
    fundsImpacted: [
      { code: "RBF572", name: "RBC Select Balanced Portfolio", estDistribution: "Most popular FHSA fund", taxImpact: "N/A", totalSales: 620000 },
      { code: "RBF573", name: "RBC Select Growth Portfolio", estDistribution: "Recommended for 5+ yr horizon", taxImpact: "N/A", totalSales: 310000 },
    ],
    clientsImpacted: [
      { id: 6, name: "Michael Okafor", accounts: ["FHSA"], funds: ["RBF572"], estTax: null, action: "Top up 2026 room — $8K available" },
      { id: 15, name: "Amira Hassan", accounts: ["FHSA"], funds: ["RBF572"], estTax: null, action: "Top up 2026 room — $8K available" },
      { id: 4, name: "Jean-Pierre Dubois", accounts: ["TFSA"], funds: [], estTax: null, action: "No FHSA yet — open account conversation" },
      { id: 12, name: "Ahmed Patel", accounts: ["TFSA"], funds: [], estTax: null, action: "No FHSA yet — strong candidate" },
    ],
  },
  {
    id: "fe5",
    title: "GIC Maturity Wave — Spring 2026",
    category: "rate_change",
    date: "2026-04-15",
    summary: "Multiple 1-year GICs maturing in April as rates roll over. Reinvestment opportunity — consider mutual fund alternatives for clients whose risk profile supports it. Rate environment shifting lower.",
    resources: [
      { title: "Current GIC vs MF Yield Comparison", url: "https://advisor.rbcgam.com/tools/gic-mf-compare" },
      { title: "Income Solutions for Maturing GICs", url: "https://advisor.rbcgam.com/resources/gic-maturity-playbook" },
    ],
    fundsImpacted: [
      { code: "RBF140", name: "RBC Bond Fund", estDistribution: "Alternative to 1-yr GIC", taxImpact: "N/A", totalSales: 280000 },
      { code: "RBF220", name: "RBC Canadian Short-Term Income", estDistribution: "Low-vol GIC alternative", taxImpact: "N/A", totalSales: 190000 },
      { code: "RBF571", name: "RBC Select Conservative Portfolio", estDistribution: "Balanced GIC step-up", taxImpact: "N/A", totalSales: 480000 },
    ],
    clientsImpacted: [
      { id: 5, name: "Sandra Williams", accounts: ["RRIF"], funds: [], estTax: null, action: "$45K GIC maturing — review income needs" },
      { id: 8, name: "Robert Kim", accounts: ["RRSP"], funds: [], estTax: null, action: "$30K GIC maturing — consider conservative MF" },
      { id: 14, name: "Brian Fowler", accounts: ["RRSP"], funds: [], estTax: null, action: "$25K GIC maturing — discuss options" },
    ],
  },
  {
    id: "fe6",
    ...
    clientsImpacted: [
      { id: 2, name: "David Thompson", accounts: ["RRSP", "TFSA"], funds: ["RBF573"], estTax: null, action: "Age 44 — likely ESG interest" },
      { id: 13, name: "Rachel Nguyen", accounts: ["RRSP", "TFSA"], funds: ["RBF572"], estTax: null, action: "HR professional — values alignment" },
      { id: 15, name: "Amira Hassan", accounts: ["TFSA", "FHSA"], funds: ["RBF573"], estTax: null, action: "Young professional — ESG candidate" },
      { id: 6, name: "Michael Okafor", accounts: ["TFSA", "FHSA"], funds: ["RBF573"], estTax: null, action: "Tech worker — sustainability interest" },
    ],
  },
];
                ...
                <tr key={i} style={{ transition: "background 0.15s" }} onMouseEnter={e => e.currentTarget.style.background = T.bg} onMouseLeave={e => e.currentTarget.style.background = T.white}>
                  ...
                  <td style={tdStyle}>
                    <span style={{
                      ...
                      background: c.action.includes("No action") || c.action.includes("monitor") ? T.bg : T.orangeLight,
                      color: c.action.includes("No action") || c.action.includes("monitor") ? T.textMid : T.orange,
                      fontFamily: "'Source Sans 3', sans-serif",
                    }}>{c.action}</span>
                  </td>
                </tr>
